...
with serial.Serial(port=args.comport,
    ...
    if args.file:
        with open(args.file, "rb") as f:
            ...
            com_port.write(f"flash_init {n_pages} {args.spi_index}\r".encode("utf8"))
            msg=com_port.read_until()
            print(msg)
            success_msg = "flash writing in progress"
            ...
            try:
                ...
                com_port.write(f"flash_final {n_pages}\r".encode("utf8"))

    if args.activate and exit_code == 0:
        com_port.write(f"flash_activate_firmware {args.spi_index}".encode())
        msg = com_port.read_until()
        print(msg)
